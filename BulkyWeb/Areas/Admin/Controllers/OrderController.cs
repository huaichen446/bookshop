...
namespace BulkyBookWeb.Areas.Admin.Controllers {
	...
	public class OrderController : Controller {
        ...
        public IActionResult UpdateOrderDetail() {
            ...
            {
                // 订单发货时更新销售计数
               // UpdateProductSalesCount(OrderVM.OrderHeader.Id);

                // 记录购买行为
                var orderDetails = _unitOfWork.OrderDetail.GetAll(u => u.OrderHeaderId == OrderVM.OrderHeader.Id);
                foreach (var detail in orderDetails)
                {
                    _unitOfWork.Recommendation.RecordUserActivity(OrderVM.OrderHeader.ApplicationUserId,
                        detail.ProductId, ActivityType.Purchase);
                }
        ...
        //private void UpdateProductSalesCount(int orderId)
        //{
